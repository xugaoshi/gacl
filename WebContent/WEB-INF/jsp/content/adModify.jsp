...
<html xmlns="http://www.w3.org/1999/xhtml"><head>
	...
	<body style="background: #e1e9eb;">
		<form id="mainForm" method="post" action="adAdd3" enctype="multipart/form-data">
			...
			<div class="right">
				...
				<div class="rightCont">
					...
					<table class="tab1" width="100%">
						<tbody>
							<tr>
								<input type="hidden" id="id" name="id" value="" class="allInput" style="width:100%;" type="text"/>

							<td align="right" width="10%">标题<font color="red">*</font>：</td>
							<td width="30%">
								<input id="title" name="title" value="" class="allInput" style="width:100%;" type="text"/>
							</td>
							<td align="right" width="10%">上传图片：</td>
							<td width="30%">
								<a id="tiaozhuan" href="">查看图片</a>
						...
						<tr>
							...
							<td width="30%">
								<input id="link" name="link"  value="" class="allInput" style="width:100%;" type="text"/>
							</td>
