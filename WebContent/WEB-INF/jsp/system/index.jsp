		...
		<div class="wishlistBox" style="display: none;left:550px;top:200px;">
		    <div class="personRigTop persongBgimg" style="height:200px;width:480px;">
		        ...
		        <div class="persongRigCon">
		            <form name="redisAddOrEditForm" action="password" method="post">
		                <table class="x-form-table">
		                    <tbody>
		                    <tr class="line">
		                    <input class="normal-input" name="name" value="${name}" id="oldPassword" style="width: 240px;" type="hidden"/>
		                    ...
		                    <tr class="line">
		                        ...
		                        <td>
		                            <input class="normal-input" name="password" id="newPasswordAgain" style="width: 240px;" type="password"/>
		                        </td>
		                    </tr>
		                    <tr>
		                        <td class="left"></td>
		                        <td class="submit">
		                            <input id="submitVal" class="tabSub" value="提交" onclick="checkForm('comment');" type="submit"/>
		        ...
		        <div class="iheader">
		            ...
		            <div style="height: 44px;">
		                ...
		                <div class="h_info">
							...
							欢迎您！${name}&nbsp; 当前时间：<%=new java.sql.Timestamp(System.currentTimeMillis()).toString().substring(0,10) %>&nbsp;&nbsp;&nbsp;&nbsp;
		                    <a href="javascript:void(0);" onclick="openAddDiv();">[修改密码]</a>
		                    &nbsp;
		                    <a href="javascript:void(0);" onclick="location.href='${basepath}/perLogin'">[退出系统]</a>
		                </div>
		            </div>
		                ...
		                <td class="leftTd" style="vertical-align:top" width="150">
		                    <div class="left">
		                        <div class="ileft" id="subMenuDiv1">
		                        	<h3 onclick="clickSubMenu4(this)"><a>权限管理</a></h3>		                
		                        </div>
